<script lang="ts">
  ...
  import type { Nutrition } from "$lib/models";

  export let nutrition: z.infer<typeof Nutrition>;
</script>
...
<table class="nutrition-table">
  <tbody>
    ...
    {/if}
    {#if nutrition.netCarbs}
      <tr>
        <td>Net Carbs</td>
        <td>{nutrition.netCarbs} g</td>
      </tr>
    {/if}
    {#if nutrition.fat}
      <tr>
